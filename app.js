...
console.log("The Pokémon in my party are:");
...
*/
console.log("The starter Pokémon are:");
...
object directly. This method should:
...
game.catchPokemon = function (pokemonObj) {
  ...
  game.items.forEach(item =>{
    if(item.name.toLocaleLowerCase()==="pokeball"){
      item.quantity--
      console.log(`the remaining pokeballs are ${item.quantity}`);
    }
  })
};
